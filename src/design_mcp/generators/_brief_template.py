...
INSTRUCTIONS_SHORT = (
    ...
    "- REFERENCE URLs are AUTO-READ: the moment the user gives any reference / "
    "competitor / sample / existing-page URL (in the brief or any answer), "
    "IMMEDIATELY call fetch_url_screenshots(url) and read the copy + layout off "
    "the returned screenshots with your vision. Do this on your own — do NOT "
    "ask the user to paste the page text and do NOT say you 'can't access' it. "
    "If a shot looks blocked / blank / like a consent wall, call again with "
    "fresh=True before ever asking for a paste.\n"
    "\n"
